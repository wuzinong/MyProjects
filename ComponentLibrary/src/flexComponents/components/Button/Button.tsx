...
export interface ButtonProps
  extends React.HTMLAttributes<HTMLButtonElement>, ButtonBaseProps {}
/** Extends the HTML `button` element with a test look and feel. */
...
export interface LinkButtonProps
  extends React.AnchorHTMLAttributes<HTMLAnchorElement>, ButtonBaseProps {}
/** Extends an `a` element, making it look like a test button. This is used for linking to external websites -
...
/** Extends a `react-router` `Link` component, making it look like a test button. */
